...
def search_address(request):
    addr = Address()
    addr.from_data(request.param, {"source_id": 0, "name": 1, "address_one": 2, "locality": 3, "state": 4, "country": 5})
    return addr
...
expected_outputs_init = {
 "123 Main St":{"123 Main St":{'ratio': 100, 'partial_ratio': 100, 'token_sort_ratio': 100, 'token_set_ratio': 100, 'partial_token_sort_ratio': 100, 'partial_token_set_ratio': 100}
               ,"456 Oak St":{'ratio': 48, 'partial_ratio': 56, 'token_sort_ratio': 48, 'token_set_ratio': 48, 'partial_token_sort_ratio': 56, 'partial_token_set_ratio': 100}
               ,"789 Pine St":{'ratio': 55, 'partial_ratio': 63, 'token_sort_ratio': 55, 'token_set_ratio': 55, 'partial_token_sort_ratio': 63, 'partial_token_set_ratio': 100}}
 ,"456 Oak St":{"123 Main St":{'ratio': 48, 'partial_ratio': 56, 'token_sort_ratio': 48, 'token_set_ratio': 48, 'partial_token_sort_ratio': 56, 'partial_token_set_ratio': 100}
                ,"456 Oak St":{'ratio': 100, 'partial_ratio': 100, 'token_sort_ratio': 100, 'token_set_ratio': 100, 'partial_token_sort_ratio': 100, 'partial_token_set_ratio': 100}
                ,"789 Pine St":{'ratio': 38, 'partial_ratio': 46, 'token_sort_ratio': 38, 'token_set_ratio': 38, 'partial_token_sort_ratio': 46, 'partial_token_set_ratio': 100}}
 ,"789 Pine St":{"123 Main St":{'ratio': 55, 'partial_ratio': 63, 'token_sort_ratio': 55, 'token_set_ratio': 55, 'partial_token_sort_ratio': 63, 'partial_token_set_ratio': 100}
                ,"456 Oak St":{'ratio': 38, 'partial_ratio': 46, 'token_sort_ratio': 38, 'token_set_ratio': 38, 'partial_token_sort_ratio': 46, 'partial_token_set_ratio': 100}
                ,"789 Pine St":{'ratio': 100, 'partial_ratio': 100, 'token_sort_ratio': 100, 'token_set_ratio': 100, 'partial_token_sort_ratio': 100, 'partial_token_set_ratio': 100}}
}
...
def test_match_tuple_init(search_address, matched_address):
    ...
    expected = expected_outputs_init[match_tuple.search_address.full_address][match_tuple.matched_address.full_address]
